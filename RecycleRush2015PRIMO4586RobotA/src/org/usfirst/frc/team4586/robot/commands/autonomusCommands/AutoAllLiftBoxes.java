...
public class AutoAllLiftBoxes extends CommandGroup {
    ...
    public  AutoAllLiftBoxes() {
        ...
        // arm.
    	/*
    		addSequential(new MoveBoxRailToTarget(4));
    		addSequential(new MoveRobotMicroSwitch(1, 0, 0, RobotMap.autoSwitch));
	    	addSequential(new MoveRobot(1, 0, 0, 1, true));
	    	addSequential(new MoveRobotMicroSwitch(1, 0, 0, RobotMap.autoSwitch));
	    	addSequential(new MoveBoxRailToTarget(2));
	    	addSequential(new MoveRobotMicroSwitch(0, 0.5, 0, RobotMap.checkContactFront1));
	    	addSequential(new MoveBoxRailToTarget(5));
	    	addSequential(new MoveRobotMicroSwitch(1, 0, 0, RobotMap.autoSwitch));
	    	addSequential(new MoveRobot(1, 0, 0, 1, true));
	    	addSequential(new MoveRobotMicroSwitch(1, 0, 0, RobotMap.autoSwitch));
    	...
    	addSequential(new MoveRobotMicroSwitch(1, 0, 0, RobotMap.autoSwitch));
    	addSequential(new MoveRobotMicroSwitch(0.3, 0.5, 0, RobotMap.checkContactFront1));
