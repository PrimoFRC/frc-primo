...
public class ResetRail extends Command {
    ...
    protected void initialize() {
    	...
    	{
    		CommandBase.boxLifterFront.setSpeed(-1*SmartDashboard.getNumber("Max speed of rails"));
    	}
    ...
    protected void execute() {
    	...
    	if(wasDown)
    	{
    		...
    		{
    			CommandBase.boxLifterFront.setSpeed(0.7*SmartDashboard.getNumber("Max speed of rails", 1));
    ...
    protected boolean isFinished() {
        return wasFinished || (CommandBase.boxLifterFront.getSpeed() > 0 && !wasDown);
    }
