 ...
 *@author mor
 */
public class  ImageProcessing extends CommandBase {
	...
	horizontalTargets = new int[MAX_PARTICLES];
                ...
                //SmartDashboard.putNumber("HueLow", 120);
                //SmartDashboard.putNumber("HueHigh", 140);
...
/**
* this function sets the speed controller speed (default 1)
* and than waits (for instance 0.5 sec)
*/
    protected void execute() {
        try {
			...
			if(scoreCompare(scores[i], false))
			{
                            ...
                            RobotTemplate.distance = computeDistance (filteredImage,  report, i) * 0.3048;
